...
load(file='results/02_richness_piscivore.Rdata'); pisc <- m 
...
focal.scaled<-scaler(focal, ID=c('diff', 'Location'), cats=FALSE)
...
pdf(file='figures-pdf/Figure2.pdf', height=6, width=8)
