...
#### SAVE TOP MODEL
save(m, focal.scaled, file='results/02_richness_corallivore.Rdata')
...
#### SAVE TOP MODEL
save(m, focal.scaled, file='results/02_richness_herbivore.Rdata')
...
#### SAVE TOP MODEL
save(m, focal.scaled, file='results/02_richness_invertivore.Rdata')
...
#### SAVE TOP MODEL
save(m, focal.scaled, file='results/02_richness_mixed-diet.Rdata')
...
#### SAVE TOP MODEL
save(m, focal.scaled, file='results/02_richness_planktivore.Rdata')
...
#### SAVE TOP MODEL
save(m, focal.scaled, file='results/02_richness_piscivore.Rdata')
